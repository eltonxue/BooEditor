...
public:
    ...
    void setCursorLine(unsigned int lineNumber);

    void setCursorColumn(unsigned int columnNumber);

    void setTotalLines(unsigned int num);

    char getPreviousCharacter() const; // used

    std::string getPreviousSubstr() const;
    ...
    void insertCharacter(char a);

    void backSpace();

    void newLine();

    void undoNewLine(std::string& substr, unsigned int previousColumn);

    void deleteLine();

    void undoDeleteLine(std::string& line, unsigned int previousColumn, unsigned int previousLine);
...
private:
    ...
    std::vector<std::string> completeText;
